function param_table = makeParameter_v0_1_tmp...
...
elseif strcmp(cur_scenario_selection,'LK_CIL_ST_all') % 30
    
    dims = [1 100];
    parameter_declaration = {'vA','vB','aB','t_cut_in','x_start','y_end'};
    definput = {'30,110,5','30,110,5','-9.81,0,5','1,5,5','10,30,5','-1.6,1.6,5'}; % [min, max, number of sampling points]
...
elseif strcmp(cur_scenario_selection,'RT_EGSR2L_IN') % 11
    ...
    % Car
elseif contains(cur_scenario_selection,'LK_LF_ST') % 1
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','offset_target','a_target','R_dec'};
    definput = {'30,110,3','30, 110,3','-1.8, 1.8,3','-8, -2,3','10, 50,3'}; % [min, max, number of sampling points]
...
elseif contains(cur_scenario_selection,'LK_CIL_') % 3-5
    ...
    definput = {'30,110,3','30, 110,3','1, 5,3','-8, 0,3','10, 50,3'}; % [min, max, number of sampling points]
...
elseif contains(cur_scenario_selection,'LK_CIR_') % 6-8
    ...
    if contains(cur_scenario_selection,'_MER')
        ...
        definput = {'30,110,3','30, 110,3','50,90,3'}; % [min, max, number of sampling points]
    else
        dims = [1 100];
        parameter_declaration = {'v_ego','v_target','t_cut_in','a_target','R_cut_in'};
        definput = {'30,110,3','30, 110,3','1, 5,3','-8, 0,3','10, 50,3'}; % [min, max, number of sampling points]
...
elseif contains(cur_scenario_selection,'LK_COL_STP_') % 9
    ...
    definput = {'30,110,3','30, 110,3','15, 25,3','1, 3,3','20, 50,3'}; % [min, max, number of sampling points]
...
elseif contains(cur_scenario_selection,'LK_STP_') % 13-14
    ...
    dims = [1 100];
    parameter_declaration = {'v_ego','offset_ego','offset_target'};
    definput = {'30,110,3','-0.9, 0.9,3','-0.9, 0.9,3'}; % [min, max, number of sampling points]
...
elseif contains(cur_scenario_selection,'LK_OVE_') % 15-16
    ...
    definput = {'30,110,3','30, 110,3','10, 50,3'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_BWD_ST') % 17
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','dist_trigger'};
    definput = {'30,110,3','-5, -1,3','10, 50,3'}; % [min, max, number of sampling points]
...
elseif strcmp(cur_scenario_selection,'LCL_LF_ST') % 18
    ...
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','duration','dist_trigger'};
    definput = {'30,110,3','30, 110,3','1, 3,3','5, 15,3'}; % [min, max, number of sampling points]
...
elseif strcmp(cur_scenario_selection,'UT_LF_ST') % 20
    ...
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','dist_trigger'};
    definput = {'5,25,3','30, 110,3','10, 50,3'}; % [min, max, number of sampling points]
...
elseif strcmp(cur_scenario_selection,'LK_LFL2R_IN') % 22
    ...
    definput = {'30,60,3','30, 60,3','-0.9, 0.9,3','10, 50,3'}; % [min, max, number of sampling points]
...
if ~isempty(definput)
    ...
    elseif strcmp(cur_scenario_selection,'LK_CIL_ST') || strcmp(cur_scenario_selection,'LK_CIL_SH')...
        ...
        total_array_const_final = total_array_const_2(total_array_const_2(:,index.TTC_Trigger) > -(w(1).*total_array_const_2(:,index.a_target) + w(2).*total_array_const_2(:,index.t_cut_in)+b)./w(3),:);
