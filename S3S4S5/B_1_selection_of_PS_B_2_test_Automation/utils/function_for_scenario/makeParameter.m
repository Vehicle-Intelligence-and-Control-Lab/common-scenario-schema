function param_table = makeParameter(cur_scenario_selection,save_path,toggle_default_parameter)
...
elseif strcmp(cur_scenario_selection,'LK_PSTP_ST') % 3
    ...
    definput = {'10,60,5','-0.9,0.9,5','10,90,5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_PWAL_ST') % 4
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','offset_ego','offset_target'};
    definput = {'10,60,5','5,8,5','-0.9,0.9,5','0.3,1.5,5'}; % [min, max, number of sampling points]
...
elseif strcmp(cur_scenario_selection,'LK_CCIR_ST') % 3
    ...
    definput = {'10,60,5','13,17,5','3,5,5','30,70,5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_CGS_ST') % 4
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','offset_ego','offset_target'};
    definput = {'10,60,5','13,17,5','-0.9,0.9,5','-1.5,1.5,5'}; % [min, max, number of sampling points]
...
elseif strcmp(cur_scenario_selection,'LK_CSTP_ST') % 5
    ...
    dims = [1 100];
    parameter_declaration = {'v_ego','offset_ego','offset_target'};
    definput = {'10,60,5','-0.9,0.9,5','-1.5,1.5,5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_COCL_ST') % 6
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','duration','dist_trigger'};
    definput = {'10,60,5','13,17,5','2,5,5','50,100,5'}; % [min, max, number of sampling points]
...
elseif strcmp(cur_scenario_selection,'RT_CSD_IN') % 17
    ...
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','offset_ego','dist_trigger'};
    definput = {'10,60,5','13,17,5','-0.9,0.9,5','10,90,5'}; % [min, max, number of sampling points]
...
elseif strcmp(cur_scenario_selection,'RT_EGSR2L_IN') % 11
    ...
    % Car
elseif strcmp(cur_scenario_selection,'LK_LF_ST') % 1
...
elseif strcmp(cur_scenario_selection,'LK_CIL_ST') % 3
...
elseif strcmp(cur_scenario_selection,'LK_CIL_SH') % 4
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','t_cut_in','a_target','R_cut_in'};
    definput = {'30,110,5','30, 110, 5','1, 5, 5','-8, 0, 5','10, 50, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_CIL_CU') % 5
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','t_cut_in','a_target','R_cut_in'};
    definput = {'30,110,5','30, 110, 5','1, 5, 5','-8, 0, 5','10, 50, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_CIR_ST') % 6
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','t_cut_in','a_target','R_cut_in'};
    definput = {'30,110,5','30, 110, 5','1, 5, 5','-8, 0, 5','10, 50, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_CIR_CU') % 7
...
elseif strcmp(cur_scenario_selection,'LK_COL_STP_ST') % 9
...
elseif strcmp(cur_scenario_selection,'LK_COL_STP_SH') % 10
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','dist_start','duration','dist_trigger'};
    definput = {'30,110,5','30, 110, 5','15, 25, 5','1, 3, 5','20, 50, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_COR_STP_ST') % 11
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','dist_start','duration','dist_trigger'};
    definput = {'30,110,5','30, 110, 5','15, 25, 5','1, 3, 5','20, 50, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_COR_STP_CU') % 12
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','dist_start','duration','dist_trigger'};
    definput = {'30,110,5','30, 110, 5','15, 25, 5','1, 3, 5','20, 50, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_STP_ST') % 13
    
    dims = [1 100];
    parameter_declaration = {'v_ego','offset_ego','offset_target'};
    definput = {'30,110,5','-0.9, 0.9, 5','-0.9, 0.9, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_STP_CU') % 14
    
    dims = [1 100];
    parameter_declaration = {'v_ego','offset_ego','offset_target'};
    definput = {'30,110,5','-0.9, 0.9, 5','-0.9, 0.9, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_OVE_ST') % 15
    
    dims = [1 100];
    parameter_declaration = {'v_ego','v_target','dist_trigger'};
    definput = {'30,110,5','30, 110, 5','10, 50, 5'}; % [min, max, number of sampling points]
    
elseif strcmp(cur_scenario_selection,'LK_OVE_CU') % 16
